...
export default function OverviewPage() {
  ...
  return (
    <div className="space-y-12 pb-16">
      {/* Page Header */}
      <div>
        <h1 className="text-2xl font-bold text-stone-900">Clever プロダクト全体像</h1>
      ...
      <section>
        ...
        <div className="mt-6 space-y-8">
          ...
          <div>
            ...
            <div className="mt-4 p-3 border border-stone-200 rounded-lg bg-white">
              <p className="text-[10px] font-bold text-stone-400 uppercase tracking-wide mb-2">Q&amp;Aで確定した事項</p>
          ...
          <div>
            ...
            <div className="mt-3 p-5 bg-white border border-stone-200 rounded-lg">
              <div className="flex items-center gap-2 mb-3">
                <h4 className="text-sm font-bold text-stone-900">UnifiedProduct</h4>
                <span className="text-[11px] text-stone-400">実装済み / localStorage に保存</span>
              </div>
          ...
          <div>
            ...
            <div className="mt-3 grid grid-cols-1 lg:grid-cols-3 gap-5">
              ...
              <div className="p-5 bg-white border border-stone-200 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  <h4 className="text-sm font-bold text-stone-900">A. 価格計算エンジン</h4>
                ...
                <div className="space-y-3">
                  <div className="p-3 border border-stone-200 rounded-lg">
                    <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wide">要件の計算式（Q&amp;Aで確認済み）</p>
                    <p className="mt-1.5 text-xs font-mono text-stone-800">
                  ...
                  <div className="p-3 border border-stone-200 rounded-lg">
                    <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wide">現在の実装</p>
                    <p className="mt-1.5 text-xs font-mono text-stone-800">
              ...
              <div className="p-5 bg-white border border-stone-200 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  <h4 className="text-sm font-bold text-stone-900">B. 在庫ステータス判定</h4>
                  <span className="text-[11px] text-stone-400">実装済み</span>
                </div>

                <div className="space-y-3">
                  <div className="p-3 border border-stone-200 rounded-lg">
                    <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wide">判定ロジック</p>
                  ...
                  <div className="p-3 border border-stone-200 rounded-lg">
                    <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wide">要件との整合</p>
                    <ul className="mt-1.5 space-y-1 text-[11px] text-stone-700">
                      <li>• 在庫0 → 納期回答 — 一致</li>
              ...
              <div className="p-5 bg-white border border-stone-200 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  <h4 className="text-sm font-bold text-stone-900">C. 類似品マッチング</h4>
                  <span className="text-[11px] text-stone-400">実装済み</span>
                </div>

                <div className="space-y-3">
                  <div className="p-3 border border-stone-200 rounded-lg">
                    <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wide">スコアリング（加重平均）</p>
                    ...
                    <p className="mt-2 text-[10px] text-stone-400">閾値: スコア ≥ 0.3 のみ表示 / 最大5件</p>
                  </div>

                  <div className="p-3 border border-stone-200 rounded-lg">
                    <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wide">フィルタ条件</p>
                    <ul className="mt-1.5 space-y-1 text-[11px] text-stone-700">
            ...
            <div className="mt-3 grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <div className="p-5 bg-white border border-stone-200 rounded-lg">
                ...
                <div className="mt-4 pt-3 border-t border-stone-100">
                  <p className="text-[10px] font-bold text-stone-400 uppercase tracking-wide">表示先</p>
                  <p className="text-xs text-stone-600 mt-0.5">本ツール（Clever）の商品検索画面 — /search</p>
                </div>
              </div>
              ...
              <div className="space-y-5">
                <div className="p-5 bg-white border border-stone-200 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    <h4 className="text-sm font-bold text-stone-900">EC価格一元管理マスタ</h4>
                    <span className="px-1.5 py-0.5 bg-stone-100 text-stone-500 text-[10px] font-bold rounded">Phase 2</span>
                  </div>
                ...
                <div className="p-5 bg-white border border-stone-200 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    <h4 className="text-sm font-bold text-stone-900">営業アシスト表示</h4>
                    <span className="text-[11px] text-stone-400">MVP内・実装済み</span>
                  </div>
                  <ul className="space-y-1.5 text-xs text-stone-600">
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-stone-50 text-left">
                <th className="px-4 py-3 font-semibold text-stone-700 rounded-tl-lg w-8">#</th>
                <th className="px-4 py-3 font-semibold text-stone-700">未確定事項</th>
                <th className="px-4 py-3 font-semibold text-stone-700">カテゴリ</th>
                <th className="px-4 py-3 font-semibold text-stone-700">影響度</th>
                <th className="px-4 py-3 font-semibold text-stone-700 rounded-tr-lg">確認先</th>
              </tr>
            </thead>
      ...
      <section>
        ...
        <div className="mt-4 p-5 bg-white border border-stone-200 rounded-lg">
          <p className="text-sm font-bold text-stone-900">MTG（5/13）での発言:</p>
          <blockquote className="mt-2 pl-3 border-l-2 border-stone-300 text-sm text-stone-600 italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
            <div className="p-3 border border-stone-200 rounded-lg">
              <p className="text-xs font-bold text-stone-800">カラム不整合</p>
              <p className="mt-1 text-xs text-stone-500">各シートでカラム名・順序・数が異なる可能性 → 現時点で3カテゴリ分のパーサーは個別実装済み</p>
            </div>
            <div className="p-3 border border-stone-200 rounded-lg">
              <p className="text-xs font-bold text-stone-800">SKU表記揺れ</p>
              <p className="mt-1 text-xs text-stone-500">同一商品が異なる品番で登録されている可能性 → ECデータとの紐付けに影響</p>
            </div>
            <div className="p-3 border border-stone-200 rounded-lg">
              <p className="text-xs font-bold text-stone-800">空セル・欠損</p>
              <p className="mt-1 text-xs text-stone-500">必須フィールド（仕入値・幅・残り）が空の場合、その行はスキップされる（現在の実装）</p>
            </div>
          </div>
        </div>
      </section>
...
function RowLabel({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-xs font-bold text-stone-400 uppercase whitespace-nowrap">{label}</span>
      <div className="h-px flex-1 bg-stone-200" />
    </div>
  )
}
  ...
  return (
    <div className="p-4 bg-white border border-stone-200 rounded-lg space-y-2">
      ...
      <div className="text-[11px] space-y-1.5">
        <p><span className="font-semibold text-stone-400">誰:</span> <span className="text-stone-700">{who}</span></p>
        <p><span className="font-semibold text-stone-400">場面:</span> <span className="text-stone-700">{scene}</span></p>
        <p><span className="font-semibold text-stone-400">困りごと:</span> <span className="text-stone-700">{pain}</span></p>
        <p className="pt-1 border-t border-stone-100"><span className="font-semibold text-stone-400">ゴール:</span> <span className="text-stone-800 font-medium">{goal}</span></p>
      </div>
    </div>
  )
}
...
function DataSourceDetailCard({ title, file, origin, hasUnknown, excluded, fields, footnote }: {
  ...
  return (
    <div className={`p-4 border rounded-lg ${excluded ? 'bg-stone-50/50 border-dashed border-stone-300' : 'bg-white border-stone-200'}`}>
      <div className="flex items-start justify-between gap-2">
        <h4 className={`text-sm font-bold ${excluded ? 'text-stone-400' : 'text-stone-900'}`}>{title}</h4>
        {excluded && <span className="px-1.5 py-0.5 bg-stone-100 text-stone-400 text-[9px] font-bold rounded">対象外</span>}
      </div>
      <p className={`mt-1 text-[10px] font-mono ${excluded ? 'text-stone-300' : 'text-stone-400'}`}>{file}</p>
      <p className={`text-[10px] ${excluded ? 'text-stone-300' : 'text-stone-400'}`}>{origin}</p>
        ...
        {fields.map((f) => (
          <div key={f.name} className="flex items-start gap-1.5 text-[11px] px-1.5 py-0.5 rounded">
            {f.unknown
              ...
              : <span className={`mt-px ${excluded ? 'text-stone-200' : 'text-stone-300'}`}>·</span>
            }
            <span className={`font-mono ${excluded ? 'text-stone-400' : f.unknown ? 'text-stone-800' : 'text-stone-600'}`}>{f.name}</span>
            {f.note && <span className="text-stone-400">— {f.note}</span>}
          </div>
        ))}
      </div>

      {footnote && (
        <p className="mt-3 text-[10px] text-stone-400 italic">{footnote}</p>
      )}
    </div>
  )
}
...
function FieldChip({ name, type, unknown, note }: { name: string; type: string; unknown?: boolean; note?: string }) {
  return (
    <div className={`px-2 py-1.5 border rounded-lg ${unknown ? 'border-rose-200 bg-rose-50/40' : 'border-stone-200 bg-stone-50/50'}`} title={note}>
      <p className={`text-[11px] font-mono font-semibold ${unknown ? 'text-stone-800' : 'text-stone-700'}`}>
        {unknown && <span className="text-rose-400 mr-1">?</span>}
        {name}
      </p>
      <p className="text-[9px] text-stone-400">{type}</p>
...
function UnknownCard({ id, title, expanded, onToggle, detail, impact }: {
  ...
  return (
    <div className="p-3 bg-white border border-stone-200 rounded-lg cursor-pointer hover:bg-stone-50 transition-colors" onClick={onToggle}>
      <div className="flex items-start gap-2">
        <span className="text-stone-400 text-sm mt-0.5">{expanded ? '▼' : '▶'}</span>
        <div className="flex-1">
          ...
          {expanded && (
            <div className="mt-2 space-y-2 text-[11px]">
              ...
              <p className="text-stone-500 font-medium">影響: {impact}</p>
            </div>
          )}
        </div>
      </div>
...
function UnknownInline({ text, className = '' }: { text: string; className?: string }) {
  return (
    <div className={`flex items-start gap-1.5 p-2 border border-dashed border-stone-300 rounded text-[10px] text-stone-500 ${className}`}>
...
function ParamRow({ name, value, unknown, note }: { name: string; value: string; unknown?: boolean; note: string }) {
  return (
    <div className="flex items-baseline gap-2 text-[11px]">
      <span className="font-mono font-semibold text-stone-600 w-24 flex-shrink-0">{name}</span>
      <span className={`font-mono font-bold ${unknown ? 'text-rose-500' : 'text-stone-800'}`}>{value}</span>
...
function StatusRule({ condition, result, resultNote }: { condition: string; result: string; resultNote: string }) {
  return (
    <div className="flex items-center gap-2 text-[11px]">
      <span className="font-mono text-stone-700 flex-1">{condition}</span>
      <span className="text-stone-300">→</span>
      <span className="px-1.5 py-0.5 bg-stone-100 rounded font-semibold text-stone-700">{result}</span>
      <span className="text-[9px] text-stone-400">{resultNote}</span>
    </div>
  )
}
...
function ScoreWeight({ label, weight, note }: { label: string; weight: string; note: string }) {
  return (
    <div className="flex items-center gap-2 text-[11px]">
      <span className="w-10 text-right font-bold text-stone-600 font-mono">{weight}</span>
      <div className="flex-1 h-1.5 bg-stone-100 rounded-full overflow-hidden">
        <div className="h-full bg-stone-400 rounded-full" style={{ width: weight }} />
      </div>
      <span className="text-stone-700 flex-shrink-0">{label}</span>
      <span className="text-[9px] text-stone-400">{note}</span>
    </div>
  )
}
...
function OutputField({ label, source, unknown, note }: { label: string; source: string; unknown?: boolean; note?: string }) {
  return (
    <div className={`flex items-baseline gap-2 px-2 py-1 rounded text-[11px] ${unknown ? 'bg-rose-50/40' : ''}`}>
      ...
      <span className="font-semibold text-stone-700 w-28 flex-shrink-0">{label}</span>
      <span className="text-stone-400 font-mono text-[10px]">← {source}</span>
      {note && <span className="text-stone-400 text-[10px]">{note}</span>}
    </div>
  )
}
...
function FlowArrowDown({ label }: { label: string }) {
  return (
    <div className="flex flex-col items-center gap-1 py-2">
      ...
      <div className="px-4 py-1.5 bg-stone-50 border border-stone-200 rounded-full">
        <p className="text-[10px] text-stone-500 text-center">{label}</p>
      </div>
...
function UnknownRow({ n, item, category, impact, who, detail }: {
  ...
  return (
    <tr className="hover:bg-stone-50">
      <td className="px-4 py-3 text-stone-400 font-mono text-xs">{n}</td>
      <td className="px-4 py-3">
        <p className="font-medium text-stone-900 text-sm">{item}</p>
        <p className="text-[11px] text-stone-400 mt-0.5">{detail}</p>
      </td>
      <td className="px-4 py-3 text-stone-500 text-xs">{category}</td>
      <td className="px-4 py-3">
        <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
          impact === 'critical' ? 'bg-rose-50 text-rose-600 border border-rose-200'
          : impact === 'high' ? 'bg-stone-100 text-stone-700'
          : 'bg-stone-50 text-stone-500'
        }`}>{impactLabel[impact]}</span>
      </td>
      <td className="px-4 py-3 text-stone-500 text-xs">{who}</td>
    </tr>
  )
}
